...
object Day02 {
  ...
  object Part2 {
    ...
    def evenlyDivisible(ints: Seq[Int]): Int = {
      ints.foldLeft(-1) { (acc, i1) =>
        ints.foldLeft(acc) { (acc, i2) =>
          if(i1 != i2 && i1 % i2 == 0)
            return i1 / i2
          else
            acc
  ...
  val input = """4168	3925	858	2203	440	185	2886	160	1811	4272	4333	2180	174	157	361	1555
                ...
                |37	1069	166	1037	172	258	1071	90	497	1219	145	1206	143	153	1067	510""".stripMargin
